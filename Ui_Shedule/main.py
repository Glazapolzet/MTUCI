...
class MainWindow(QWidget):
    ...
    def _update_table(self, table_gbox):
        tmp = "SELECT * FROM service.shedule WHERE day='{}' and (evenodd='{}' OR evenodd='ео')".format(table_gbox,
                                                                                                           evenodd())
    ...
    def _change_day_from_table(self, button):
        ...
        try:
            ...
            tmp = "UPDATE service.shedule SET subject='{0}', room_numb='{1}', start_time='{2}', evenodd='{3}' " \
            ...
            if box[1] == com[1]:
                ...
                for i in range(self.table.columnCount()):
                    try:
                        ...
                        row.append(None)
        try:
            tmp = "DELETE FROM service.shedule WHERE day='{}' and subject='{}' " \
    ...
    def _insert_row_table(self):
        try:
            ...
            tmp = "INSERT INTO service.shedule (id,day, subject,room_numb,start_time,evenodd) " \
