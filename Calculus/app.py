...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.vbox.addLayout(self.hbox_op)
        ...
        self.hbox_zero.addWidget(self.b_float)

        self.b_plus = QPushButton("+", self)
        self.hbox_zero.addWidget(self.b_plus)

        self.b_minus = QPushButton("-", self)
        self.hbox_op.addWidget(self.b_minus)

        self.b_mult = QPushButton("*", self)
        self.hbox_op.addWidget(self.b_mult)

        self.b_div = QPushButton("/", self)
        self.hbox_op.addWidget(self.b_div)
    ...
    def _result(self):
        ...
        if self.op == "/" and self.num_2 == 0:
            self.input.setText('THATS WRONG!')
        elif self.op == "/":
            self.input.setText(str(self.num_1 / self.num_2))
